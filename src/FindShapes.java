...
public class FindShapes {
    public static void main(String[] args) {
        ...
        System.out.println("Trapezoid area is: " + trapezoid.getArea());
        System.out.println("Parallelogram area is: " + parallelogram.getArea()) ;
        ...
        System.out.println("Parallelogram perimeter is: " + parallelogram.getPerimeter());
        ...
        System.out.println("The Parallelogram and rectangle areas add to: " + parallelogram.addArea(rec1));
        ...
        System.out.println("There are now " + parallelogram.getcount() + " shapes");
        parallelogram.decCount();
        parallelogram = null;                          // Allow  JAVA to garbarge collect detroyed instance.
        try {
